...
VERIFIED_SITES: tuple[VerifiedSite, ...] = (
    VerifiedSite(
        ...
        (
            ...
            "deepseek.com", "*.edu.hk", "*.edu.mo", "*.edu.tw", "foxmail.com",
            "gmail.com", "*.gov.cn", "qq.com", "sina.cn", "sina.com", "sohu.com",
            "xiaomi.com", "yahoo.com", "privaterelay.appleid.com", "xpertiise.com",
            "linux.do", "ahnu.edu.cn", "baiyunu.edu.cn", "bit.edu.cn", "buaa.edu.cn",
            "cdjcc.edu.cn", "cug.edu.cn", "email.swu.edu.cn", "email.szu.edu.cn",
            "emails.bjut.edu.cn", "gdpt.edu.cn", "hhu.edu.cn", "hnu.edu.cn",
            "hust.edu.cn", "jstc.edu.cn", "lut.edu.cn", "m.scnu.edu.cn",
            "mail.scut.edu.cn", "mail.sdu.edu.cn", "mail.sustech.edu.cn",
            "mail.ustc.edu.cn", "mails.cust.edu.cn", "my.swjtu.edu.cn", "njpji.edu.cn",
            "nuist.edu.cn", "scun.edu.cn", "sdust.edu.cn", "smail.swufe.edu.cn",
            "st.gxu.edu.cn", "st.nuc.edu.cn", "stmail.ujs.edu.cn", "stu.ecnu.edu.cn",
            "stu.edu.cn", "stu.jxufe.edu.cn", "stu.pku.edu.cn", "stu.qlu.edu.cn",
            "stu.xhu.edu.cn", "stu.xpu.edu.cn", "tju.edu.cn", "tongji.edu.cn",
            "whu.edu.cn", "wtu.edu.cn", "zju.edu.cn",
        ),
    ),
    VerifiedSite(
